...
installer leaves this drop-in in place and restarts k3s only when its managed
content changes. After cached images import, the installer uses the cached `rwx-check`
